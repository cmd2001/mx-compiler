...
public class TypeBuilder {
    public Type build(BasicTypeNode basicTypeNode) {
        ...
        if(basicTypeNode.isIdentifier) return new ClassType(basicTypeNode.id, null);
    ...
    public Type build(TypeNode typeNode) {
